...
meta.tdlibrary=fullfile(meta.localdatafolder,'fine-td-library');
...
switch(meta.task)
    case 'COactpas'
        ...
        signal_info = { ...
            ...
            'label',{...
                ...
                getMarkerNames(cds_cell{1}),...
                strcat(getJointNames(cds_cell{1}),'_ang'),...
                strcat(getJointNames(cds_cell{1}),'_vel'),...
                strcat(getMuscleNames(cds_cell{1}),'_len'),...
                strcat(getMuscleNames(cds_cell{1}),'_vel'),...
                strcat({'opensim_hand_pos_'},{'x','y','z'}),...
                strcat({'opensim_hand_vel_'},{'x','y','z'}),...
                strcat({'opensim_hand_acc_'},{'x','y','z'}),...
                strcat({'opensim_elbow_pos_'},{'x','y','z'}),...
                strcat({'opensim_elbow_vel_'},{'x','y','z'}),...
                strcat({'opensim_elbow_acc_'},{'x','y','z'}),...
                'startTime',...
                'endTime',...
                'tgtOnTime',...
                'goCueTime',...
    ...
    case 'TRT'
        ...
        signal_info = { ...
            ...
            'routine',event_routine, ...
            'params',struct(), ...
            'name',{'startTime','endTime','tgtOnTime','goCueTime','bumpTime','targetStartTime','ctHoldTime','otHoldTime'}, ...
            'type','event', ...
            'label',{'startTime','endTime','tgtOnTime','goCueTime','bumpTime','targetStartTime','ctHoldTime','otHoldTime'}), ...
            };
        ...
        trial_data.trialID = cds_cell{1}.trials.number';
        trial_data.result = cds_cell{1}.trials.result';
        trial_data.ctrHoldBump = cds_cell{1}.trials.spaceNum';
        trial_data.bumpDir = cds_cell{1}.trials.bumpDir';
        trial_data = reorderTDfields(trial_data);
